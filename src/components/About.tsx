        ...
        <div className="About container text-justify p-4">
            <div className="grid row">
                ...
                <div className="col-lg-8 pt-2">
                    ...
                    <p>Maître Stéphanie KOLMER-IENNY est avocat inscrit au Barreau de
                        ...
                        patrimoine.</p>
                    <p>Elle intervient à la fois comme conseil
                        ...
                        pour engager une procédure contre l'adversaire.</p>
                </div>
            </div>
        </div>
    );
